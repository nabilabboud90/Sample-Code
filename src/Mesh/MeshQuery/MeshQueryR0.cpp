...
MeshQuery* createMeshQueryR0() {
  return new MeshQueryR0;
}


MeshQueryR0::MeshQueryR0() {
}
...
void
MeshQueryR0::Setup( const NSParser::NSInput::Datafile& p_datafile, const std::string& p_sectionPath, const std::string& p_sectionName ) {
  MeshQuery::Setup( p_datafile, p_sectionPath, p_sectionName );
}


void
MeshQueryR0::Initialize( const std::shared_ptr<const NSCommunicator::NSMPIComWrapper::MPIComWrapper>& p_mpiCom, int p_nDim ) {
...
void
MeshQueryR0::_initializeConnectivityInfoProtocol() {
  _connectivityInfoProtocol.insert( std::make_pair( NSMesh::Topology::tp_ELEMENT, std::vector<NSMesh::Topology>{NSMesh::Topology::tp_VERTEX, NSMesh::Topology::tp_EDGE} ) );
  if( _ndim == 3 ) {
...
void
MeshQueryR0::_initializeConnectivityFunctionPointersArray() {
  ...
  element_connectivity_function_vector[ NSMesh::Topology::tp_ELEMENT ] = &MeshQueryR0::_elementToElement;
  element_connectivity_function_vector[ NSMesh::Topology::tp_FACE ] = &MeshQueryR0::_elementToFace;
  element_connectivity_function_vector[ NSMesh::Topology::tp_EDGE ] = &MeshQueryR0::_elementToEdge;
  element_connectivity_function_vector[ NSMesh::Topology::tp_VERTEX ] = &MeshQueryR0::_elementToVertex;
  ...
  face_connectivity_function_vector[ NSMesh::Topology::tp_FACE ] = &MeshQueryR0::_faceToFace;
  face_connectivity_function_vector[ NSMesh::Topology::tp_ELEMENT ] = &MeshQueryR0::_faceToElement;
  face_connectivity_function_vector[ NSMesh::Topology::tp_EDGE ] = &MeshQueryR0::_faceToEdge;
  face_connectivity_function_vector[ NSMesh::Topology::tp_VERTEX ] = &MeshQueryR0::_faceToVertex;
  ...
  edge_connectivity_function_vector[ NSMesh::Topology::tp_EDGE ] = &MeshQueryR0::_edgeToEdge;
  edge_connectivity_function_vector[ NSMesh::Topology::tp_ELEMENT ] = &MeshQueryR0::_edgeToElement;
  edge_connectivity_function_vector[ NSMesh::Topology::tp_FACE ] = &MeshQueryR0::_edgeToFace;
  edge_connectivity_function_vector[ NSMesh::Topology::tp_VERTEX ] = &MeshQueryR0::_edgeToVertex;
  ...
  vertex_connectivity_function_vector[ NSMesh::Topology::tp_VERTEX ] = &MeshQueryR0::_vertexToVertex;
  vertex_connectivity_function_vector[ NSMesh::Topology::tp_ELEMENT ] = &MeshQueryR0::_vertexToElement;
  vertex_connectivity_function_vector[ NSMesh::Topology::tp_FACE ] = &MeshQueryR0::_vertexToFace;
  vertex_connectivity_function_vector[ NSMesh::Topology::tp_EDGE ] = &MeshQueryR0::_vertexToEdge;
...
void
MeshQueryR0::Begin( const NSMesh::Topology& from_topology, const NSMesh::Topology& to_topology, const std::vector<std::vector<const NSMesh::NSEntity::Entity*> >& p_connectivityInfo, std::vector<const NSMesh::NSEntity::Entity*>& p_connectedEntitiesVec ) const {  
  (this->*_getConnectivity[ from_topology ][ to_topology ])( p_connectivityInfo, p_connectedEntitiesVec );
}


void
MeshQueryR0::_elementToElement( const std::vector<std::vector<const NSMesh::NSEntity::Entity*> >& p_connectivityInfo, std::vector<const NSMesh::NSEntity::Entity*>& p_connectedEntitiesVec ) const {
  p_connectedEntitiesVec = p_connectivityInfo[ NSMesh::Topology::tp_ELEMENT ];
}


void
MeshQueryR0::_elementToFace( const std::vector<std::vector<const NSMesh::NSEntity::Entity*> >& p_connectivityInfo, std::vector<const NSMesh::NSEntity::Entity*>& p_connectedEntitiesVec ) const {
  p_connectedEntitiesVec = p_connectivityInfo[ NSMesh::Topology::tp_FACE ];
}


void
MeshQueryR0::_elementToEdge( const std::vector<std::vector<const NSMesh::NSEntity::Entity*> >& p_connectivityInfo, std::vector<const NSMesh::NSEntity::Entity*>& p_connectedEntitiesVec ) const {
  p_connectedEntitiesVec = p_connectivityInfo[ NSMesh::Topology::tp_EDGE ];  
}


void
MeshQueryR0::_elementToVertex( const std::vector<std::vector<const NSMesh::NSEntity::Entity*> >& p_connectivityInfo, std::vector<const NSMesh::NSEntity::Entity*>& p_connectedEntitiesVec ) const {
  p_connectedEntitiesVec = p_connectivityInfo[ NSMesh::Topology::tp_VERTEX ];
}


void
MeshQueryR0::_faceToFace( const std::vector<std::vector<const NSMesh::NSEntity::Entity*> >& p_connectivityInfo, std::vector<const NSMesh::NSEntity::Entity*>& p_connectedEntitiesVec ) const {
  p_connectedEntitiesVec = p_connectivityInfo[ NSMesh::Topology::tp_FACE ];
}


void
MeshQueryR0::_faceToElement( const std::vector<std::vector<const NSMesh::NSEntity::Entity*> >& p_connectivityInfo, std::vector<const NSMesh::NSEntity::Entity*>& p_connectedEntitiesVec ) const {
  p_connectedEntitiesVec = p_connectivityInfo[ NSMesh::Topology::tp_ELEMENT ];
}


void
MeshQueryR0::_faceToEdge( const std::vector<std::vector<const NSMesh::NSEntity::Entity*> >& p_connectivityInfo, std::vector<const NSMesh::NSEntity::Entity*>& p_connectedEntitiesVec ) const {
  p_connectedEntitiesVec = p_connectivityInfo[ NSMesh::Topology::tp_EDGE ];
}


void
MeshQueryR0::_faceToVertex( const std::vector<std::vector<const NSMesh::NSEntity::Entity*> >& p_connectivityInfo, std::vector<const NSMesh::NSEntity::Entity*>& p_connectedEntitiesVec ) const {
...
void
MeshQueryR0::_edgeToEdge( const std::vector<std::vector<const NSMesh::NSEntity::Entity*> >& p_connectivityInfo, std::vector<const NSMesh::NSEntity::Entity*>& p_connectedEntitiesVec ) const {
  p_connectedEntitiesVec = p_connectivityInfo[ NSMesh::Topology::tp_EDGE ];
}

 
void
MeshQueryR0::_edgeToElement( const std::vector<std::vector<const NSMesh::NSEntity::Entity*> >& p_connectivityInfo, std::vector<const NSMesh::NSEntity::Entity*>& p_connectedEntitiesVec ) const {
...
void
MeshQueryR0::_edgeToFace( const std::vector<std::vector<const NSMesh::NSEntity::Entity*> >& p_connectivityInfo, std::vector<const NSMesh::NSEntity::Entity*>& p_connectedEntitiesVec ) const {
...
void
MeshQueryR0::_edgeToVertex( const std::vector<std::vector<const NSMesh::NSEntity::Entity*> >& p_connectivityInfo, std::vector<const NSMesh::NSEntity::Entity*>& p_connectedEntitiesVec ) const {
  p_connectedEntitiesVec = p_connectivityInfo[ NSMesh::Topology::tp_VERTEX ];
}


void
MeshQueryR0::_vertexToVertex( const std::vector<std::vector<const NSMesh::NSEntity::Entity*> >& p_connectivityInfo, std::vector<const NSMesh::NSEntity::Entity*>& p_connectedEntitiesVec ) const {
  p_connectedEntitiesVec = p_connectivityInfo[ NSMesh::Topology::tp_VERTEX ];
}


void
MeshQueryR0::_vertexToElement( const std::vector<std::vector<const NSMesh::NSEntity::Entity*> >& p_connectivityInfo, std::vector<const NSMesh::NSEntity::Entity*>& p_connectedEntitiesVec ) const {
  p_connectedEntitiesVec = p_connectivityInfo[ NSMesh::Topology::tp_ELEMENT ];
}


void
MeshQueryR0::_vertexToFace( const std::vector<std::vector<const NSMesh::NSEntity::Entity*> >& p_connectivityInfo, std::vector<const NSMesh::NSEntity::Entity*>& p_connectedEntitiesVec ) const {
...
void
MeshQueryR0::_vertexToEdge( const std::vector<std::vector<const NSMesh::NSEntity::Entity*> >& p_connectivityInfo, std::vector<const NSMesh::NSEntity::Entity*>& p_connectedEntitiesVec ) const {
  p_connectedEntitiesVec = p_connectivityInfo[ NSMesh::Topology::tp_EDGE ];
}
